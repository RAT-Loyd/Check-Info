...
void SBStat() 
{
    ...
    if (SBstatL.find("True") != std::string::npos) {
        print::set_text("セキュアブート : 有効\n", Green);
    }
    else{
        print::set_text("セキュアブート : 無効\n", Red);
    }
...
void HVCIStat()
{
    ...
    if (HVCIStat == 1) {
        print::set_text(("HVCI : 有効 \n"), Green);
    }
    else {
        print::set_text(("HVCI : 無効 \n"), Red);
    }
...
void VT() {
    ...
    if (VTstatL.find("True") != std::string::npos) {
        print::set_text("仮想化 : 有効\n", Green);
    }
    else if (VTstatL.find("False") != std::string::npos) {
        print::set_text("仮想化 : 無効\n", Red);
    }
}
...
void RTPStat()
{
    ...
    if (RTPStatL.find("False") != std::string::npos) {
        print::set_text("リアルタイム保護 : 有効 \n", Green);
    }
    else if (RTPStatL.find("True") != std::string::npos) {
        print::set_text("リアルタイム保護 : 無効 \n", Red);
    }
}
...
void FirewallStat()
{
    ...
    if (DomStat == 1) {
        print::set_text(("ドメインネットワーク : 有効 \n"), Green);

    }
    else {
        print::set_text(("ドメインネットワーク : 無効 \n"), Red);

    }
    if (PrvStat == 1) {
        print::set_text(("プライベートネットワーク : 有効 \n"), Green);

    }
    else {
        print::set_text(("プライベートネットワーク : 無効 \n"), Red);

    }
    if (PubStat == 1) {
        print::set_text(("パブリックネットワーク : 有効 \n"), Green);

    }
    else {
        print::set_text(("パブリックネットワーク : 無効 \n"), Red);
...
void Winver() 
{
    ...
    std::cout << "Windowsバージョン: " << winver <<"(" << buildnumber << "." << ubr << ")" << std::endl;
} 
...
void VGKStat()
{
    ...
    if (system(vgk.c_str()) == 0) {
        ...
        print::set_text(("Vanguard : 有効 \n"), Green);

    }
    else {
        print::set_text(("Vanguard : 無効 \n"), Red);
    }
...
void FaceitStat() {
    ...
    if (system(faceitService.c_str()) == 0) {
        print::set_text(("Faceit : 有効 \n"), Green);
    }
    else {
        print::set_text(("Faceit : 無効 \n"), Red);
    }
}
